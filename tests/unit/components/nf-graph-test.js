...
test('graph xMinMode push', function(){
	var graph = this.subject({
		xMinMode: 'push',
		xMin: 50,
	});
...
test('graph xMinMode push-tick', function(){
	var graph = this.subject({
		xMinMode: 'push-tick',
		xMin: 50,
		xAxis: {
